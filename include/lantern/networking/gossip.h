...
int lantern_gossip_topic_format(enum lantern_gossip_topic_kind kind,
                                const char *network_name, char *buffer,
                                size_t buffer_len);

int lantern_gossip_topic_format_subnet(enum lantern_gossip_topic_kind kind,
